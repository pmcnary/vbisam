...
static int
irowinsert (const int ihandle, char *pcrow_buffer, vbisam_off_t trownumber)
{
	struct VBKEY	*pskey;
	struct DICTINFO	*psvbptr;
	struct keydesc	*pskptr;
	vbisam_off_t		tdupnumber[MAXSUBS];
...
int
ivbwriterow (const int ihandle, char *pcrow, const vbisam_off_t trownumber)
{
	struct DICTINFO	*psvbptr;
	int		iresult = 0;
