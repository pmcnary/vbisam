...
islock (const int ihandle)
{
	...
	return ivbdatalock (ihandle, VBWRLOCK, (vbisam_off_t)0);
}
...
isrelease (const int ihandle)
{
	...
	ivbdatalock (ihandle, VBUNLOCK, (vbisam_off_t)0);	/* Ignore the return */
	return 0;
}
...
isunlock (const int ihandle)
{
	...
	return ivbdatalock (ihandle, VBUNLOCK, (vbisam_off_t)0);
}
