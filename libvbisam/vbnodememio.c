...
static int
iquicknodesave (const int ihandle, struct VBTREE *pstree, const vbisam_off_t tnodenumber,
...
inewroot (const int ihandle, const int ikeynumber, struct VBTREE *pstree,
	  ...
	  struct VBKEY *psrootkey[], vbisam_off_t tnewnode1, vbisam_off_t tnewnode2)
{
	    ...
	    struct VBKEY *pskeyhalfway)
{
	...
	vbisam_off_t		tnewnode1, tnewnode2 = 0;
	int		iresult;
...
ivbnodeload (const int ihandle, const int ikeynumber, struct VBTREE *pstree,
	     const vbisam_off_t tnodenumber, const int iprevlvl)
{
	struct DICTINFO	*psvbptr;
...
ivbnodesave (const int ihandle, const int ikeynumber, struct VBTREE *pstree,
	     const vbisam_off_t tnodenumber, const int imode, const int iposn)
{
	struct DICTINFO	*psvbptr;
